...
"=====================================================
set wcm=<Tab>
menu Exec.Ruby    :!/usr/bin/irb<CR>
menu Exec.Python  :!/usr/bin/python3<CR>
...
nmap <F5> :tabprev<CR> " предидущая
nmap <F6> :tabnext<CR> " следующая
imap <F5> <ESC>:tabprev<CR>i
imap <F6> <ESC>:tabnext<CR>i
"nmap <F4> :tabe<SPACE>
"imap <F4> <ESC>:tabe<SPACE>
...
set smarttab
set shiftwidth=2 " количество пробелов используемое в командах отступа, пример >>, или <<;
set softtabstop=2
set tabstop=2 "количество пробелов используемых для табуляции
